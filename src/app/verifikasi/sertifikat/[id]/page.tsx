            ...
            <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-4 sm:p-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-slate-500">ID Sertifikat</p>
                    <p className="font-mono text-xs font-medium text-slate-700 mt-1 break-all">{id.substring(0, 16)}...</p>
                  </div>
                </div>
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-slate-700 mt-1">Real-time Validation</p>
                  </div>
                </div>
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-slate-500">Keamanan</p>
                    <p className="font-medium text-slate-700 mt-1">SSL Encrypted</p>
                  </div>
                </div>
              </div>
            </div>
